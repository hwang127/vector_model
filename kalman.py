...
from kalman_utils import array1d, array2d, check_random_state, \
...
class KalmanFilter(object):
    ...
    def smooth(self, X):
        ...
        (smoothed_state_means, smoothed_state_covariances,smoothing_gain) = (
            _smooth(
        ...
        return (smoothed_state_means, smoothed_state_covariances,smoothing_gain)
